...
public class MultiToucPractice extends GenericWrappers{

	@Test
	public void runTC() {
		launchAndroidApp("My samsung", "com.the511plus.MultiTouchTester", "com.the511plus.MultiTouchTester.MultiTouchTester","", "");
